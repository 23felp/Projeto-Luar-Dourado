...
<head>
  ...
  <?php include("sidebarDeslogado.php"); ?>
  ...
  $erro = $_GET['erro'] ?? '';
  ?>
   <div class="login-user" style="background-color: #ffffff;">
      <h2>Login</h2>
      <?php if ($erro): ?>
      ...
      <p><a href="inscrever.php" class="linklogin" style="color: #1b2c51;">Não tem conta? | Cadastre-se</a></p>
  </div>
</section>
